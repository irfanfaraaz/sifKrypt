            ...
            <div className='flex mf:flex-row flex-col  items-start justify-between md:p-20 py-12 px-4'>
                <div className='flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    <p className='text-left mt-5  text-white font-light md:w-9/12 w-11/12 text-base'>
                        Explore the world of crypto with us. <br /> Buy and sell cryptocurrencies with ease.
                    </p>
                    {!currentAccount &&(
                ...
                <div className='flex  flex-col flex-1 items-centre justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-com rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism'>
                        <div className='flex justify-between flex-col w-full h-full'>
                            ...
                            <div>
                                <p className='text-white font-light indes-sm'>
                                    {shortenAddress(currentAccount)}
                                </p>    
                                <p className='text-white font-semibold indes-lg mt-1'>
                                    Ethereum
                                </p>    
                            </div>  
                        </div>
